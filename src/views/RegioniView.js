    ...
    return (<div className="re-box re-box-map">
                <div className="map">
                    ...
                    <div key={object.X + "_" + object.Y} 
                        className={"hex " + 
                        (object.IsCostruibile(props.partita, props.burocrazie, props.regioni) ? "costruibile" : "") + 
                        (object.IsCostruita ? "costruita " : "") + (object.IsSmantellata ? "smantellata " : "") + (object.IsProduttiva ? "produttiva " : "") + (object.IsDaSmantellare ? "da-smantellare " : "" ) } 
