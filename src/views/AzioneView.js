...
function AzioneView(props) {
    ...
    return (<Button variant={props.azione.Classe} className={"col " +(props.azione.FasiInCuiVisibile.includes(props.partita.Fase) ? "" : "d-none")} onClick={() => props.handleAction(props.azione)} >{props.azione.Testo}</Button>)
